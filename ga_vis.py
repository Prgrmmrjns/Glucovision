...
with open(f'{RESULTS_PATH}/bezier_params/d1namo_generic_all_patients_bezier_params.json', 'r') as f:
...
current_patient_weight = CURRENT_PATIENT_WEIGHT
...
for p in PATIENTS_D1NAMO:
    ...
    patient_data = add_temporal_features(global_params, OPTIMIZATION_FEATURES_D1NAMO, patient_glucose, patient_combined, prediction_horizon)
